      ...
      *  Project     : REPORT 3                                        *        
      *                                                                *        
      *  Function    : DISPLAY RECORDS WITH PAGE AND PARTNER BREAK     *        
      *                                                                *        
      *----------------------------------------------------------------*        
      ...
      *
       FILE-CONTROL.
           SELECT REP-IN ASSIGN TO REP3IN
      ...
      *
       01 WS-VARIABLES.
          ...
          05 WS-REC-OUT.
             ...
             10 FILLER                      PIC X(7).
             10 WS-R-COST-VALUE             PIC Z(04)9.99.
             10 FILLER                      PIC X(8).
             10 WS-R-RETAIL-VALUE           PIC Z(04)9.99.
             10 FILLER                      PIC X(3).
      ...
      *
       ...
       01 WS-UNIT-COUNT                     PIC 9(9)    VALUE 0.
       01 WS-COST-VALUE-COUNT               PIC 9(9)    VALUE 0.
       01 WS-RETAIL-VALUE-COUNT             PIC 9(9)    VALUE 0.
      *
      * Messages...
      *
       01 WS-MESSAGES.
          ...
          05 WS-HEADER2-MSG.
             ...
             10 WS-H2-TITLE                 PIC X(52)   VALUE
                'REPORT "DISPLAY RECORDS WITH PAGE AND PARTNER BREAK"'.
          ...
          05 WS-HEADER4-MSG.
             10 WS-H4-PARTNER               PIC X(9)    VALUE 
                'PARTNER: '.
             10 WS-H4-CODE                  PIC XX      VALUE '01'.
          05 WS-HEADER5-MSG.
             10 WS-H5-PARTNER               PIC X(7)    VALUE 'PARTNER'.
             10 FILLER                      PIC X(4)    VALUE SPACES.
             10 WS-H5-REGION                PIC X(6)    VALUE 'REGION'.
             10 FILLER                      PIC X(4)    VALUE SPACES.
             10 WS-H5-AREA                  PIC X(4)    VALUE 'AREA'.
             10 FILLER                      PIC X(4)    VALUE SPACES.
             10 WS-H5-BRANCH                PIC X(6)    VALUE 'BRANCH'.
          ...
          05 WS-TOTALS.   
             ...
             10 FILLER                      PIC X(4)    VALUE SPACES.
             10 WS-COST-VALUES              PIC Z(7)9.99.
             10 FILLER                      PIC X(5)    VALUE SPACES.
             10 WS-RETAIL-VALUES            PIC Z(7)9.99.
